...
var columnFilters = {};
var data=document.getElementById("LearnerList").value;

console.log(data);

var learner=JSON.parse(data);
var learnerResultList=[];
        for(var i=0; i<learner.length; i++){
    learnerResultList.push(learner[i]['learnerId']);
     console.log(learner[i]['learnerId']);
...
function myfunction(Id){
    console.log(Id);
    var ID1=Id;
     window.location='/updateGrade?LearnerId='+ID1;
}
}	
