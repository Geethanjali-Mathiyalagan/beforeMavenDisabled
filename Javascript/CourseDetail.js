...
var grid;
var valueId = document.getElementById("Idvalue")
var columnFilters = {};
var data = document.getElementById("instructorsList").value;

console.log(data);
var instruct = JSON.parse(data);
var instructorEnroll = [];
for (var i = 0; i < instruct.length; i++) {
	instructorEnroll.push(instruct[i]['instructorId']);
	console.log(instruct[i]['instructorId']);
	/* set unique it to array */
	/* set unique it to array */

	var nextId = 1;

	instruct.forEach(function(item) {
	...
	var columns = [{
		...
		id: "ratingOfInstructor",

		name: "Rating Of Instructor",

		field: "ratingOfInstructor",
	...
	function linkFormatter(row, cell, value, columnDef, dataContext) {
		let a = dataContext.instructorId;
		return '<button onclick="myfunction(' + a + ')">Click</button>';
	}
function starFormatter(row, cell, value, columnDef, dataContext) {
	...
	function myfunction(Id) {
		console.log(Id);
		var ID1 = Id;
		window.location = '/apply?InstructorId=' + ID1;
	}
}
